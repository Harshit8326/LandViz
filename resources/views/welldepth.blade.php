...
<body>
  ...
  <div class="main">
    ...
    <form method="GET" action="{{ url('welldepth') }}" style="margin-top: 20px; margin-bottom: 20px; display: flex; gap: 20px; flex-wrap: wrap; align-items: flex-end;">
  
  <div class="form-group" style="flex: 1 1 250px;">
    <label for="locality">Filter by Locality Address</label>
    <input type="text" name="locality" id="locality" value="{{ request('locality') }}" placeholder="Enter locality address" style="width: 100%; padding: 10px; box-sizing: border-box;">
  </div>

  <div class="form-group" style="flex: 1 1 250px;">
    <label for="wellType">Filter by Well Type</label>
    <input type="text" name="wellType" id="wellType" value="{{ request('wellType') }}" placeholder="Enter well type" style="width: 100%; padding: 10px; box-sizing: border-box;">
  </div>
